...
export class ProductsService {
    products: string[] = ['laptop', "Iphone", "Ipad", "Ipod", 'phone', 'tablet', 'monitor', 'keyboard', 'mouse', 'printer', "speaker", 'webcam', 'headphones', 'microphone', 'projector', 'scanner', 'external hard drive', 'USB flash drive', 'power bank', 'smartwatch', 'fitness tracker', 'VR headset', 'gaming console'];
    // get all products
    getAllProducts() {
