...
export class ProductsService {
    products: string[] = ['laptop', "mackbock", "Iphone", "Ipad", 'phone', 'tablet',  'keyboard', 'mouse', 'printer', "speaker", 'webcam', 'headphones', 'microphone', 'projector', 'scanner', 'external hard drive', 'USB flash drive', 'power bank', 'smartwatch', 'fitness tracker', 'VR headset', 'gaming console', 'monitor', 'laptop stand'];
    // get all products
    getAllProducts() {
